# 💫 Who is William Goi?
Software Engineer .NET with over 7 years of experience, using ASPNET MVC/Core, REST API, Azure DevOps CI/CD, SQL Server, MongoDB, Neo4j, EntityFramework Core, NHibernate, Dapper, Specflow, JavaScript and Jquery(in legacy projects).<br/>
